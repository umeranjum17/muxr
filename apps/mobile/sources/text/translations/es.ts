...
export const es: TranslationStructure = {
    ...
    plugins: {
        ...
        limits: {
            ...
            paceExhausted: 'Agotado',
            paceOnTrack: 'A buen ritmo',
            paceAhead: 'Por delante del ritmo',
            ...
            runsOutIn: ({ time }: { time: string }) => `se agota en ${time}`,
            asOf: ({ time }: { time: string }) => `Límites a partir de las ${time}`,
        },
        rightNow: {
            title: 'Ahora mismo',
            ...
            refreshFailed: 'No se pudo actualizar · toca para reintentar',
            refreshNow: 'Actualizar el uso ahora',
            refreshThrottled: ({ seconds }: { seconds: number }) => `Actualización disponible en ${seconds} s`,
    ...
    spacesTree: {
        ...
        noMatches: 'Ningún espacio coincide',
        expand: 'Mostrar más',
    ...
    commandPalette: {
        ...
        common: 'Comunes',
        allCommands: ({ kind }: { kind: string }) => `Todos los comandos de ${kind}`,
        destructive: 'Destructivos · piden confirmación',
        custom: 'Personalizado',
        typeCommand: 'Escribe un comando…',
        insertSlash: 'Inserta / en el compositor',
        ...
        yourCommands: 'Tus comandos',
        editQuickActions: 'Editar respuestas y comandos…',
    },
    ...
    sessionArtifacts: {
        title: ({ count }: { count: number }) => count === 1 ? '1 artefacto' : `${count} artefactos`,
    },

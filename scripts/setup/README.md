...
scripts/setup/
  ...
  domain/                   pairing, connection, enrollment, machine crypto, daemon mode
...
- Browser grants last eight hours by default, 30 days for an explicit personal grant (`--browser-personal`); native grants are durable.

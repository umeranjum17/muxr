...
export const es: TranslationStructure = {
    ...
    plugins: {
        ...
        partialList: ({ shown, total }: { shown: number; total: number }) => `Mostrando los primeros ${shown} de ${total}. Abre el terminal para ver el resto.`,
    ...
    settings: {
        ...
        pushSubtitleSubscribed: 'Agentes bloqueados y fallidos',
        ...
        pushSubtitleDefault: 'Cuando un agente necesita una respuesta',

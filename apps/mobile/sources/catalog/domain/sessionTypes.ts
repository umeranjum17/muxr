import { z } from "zod";
// The Agent session: the product's own record of a session and its agent
// state, including the host wire shapes it round-trips. Unknown metadata keys
// stay on the passthrough object so a newer host field is not dropped on
// read-modify-write.

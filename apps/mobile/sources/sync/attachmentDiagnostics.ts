...
export type AttachmentTransferTarget = 'muxr-api' | 'external-storage' | 'unknown';
...
const ATTACHMENT_DIAGNOSTIC_ERROR_BRAND: unique symbol = Symbol('muxr.attachment-diagnostic-error');
...
export function classifyAttachmentTransferTarget(
    ...
    return host === serverHost ? 'muxr-api' : 'external-storage';
}

...
export const LocalSettingsSchema = z.object({
    ...
    terminalBars: z.enum(['seamless', 'raised']).catch('seamless').describe('Whether the terminal header and footer share the terminal canvas or sit one step lighter'),

...
it mounts slots and draws widgets. Voice and usage
are ordinary plugins that compose those widgets and call host backends.
Dictation, the terminal key row, the workspace tree, and Panes are product code. Preview transport is kernel substrate for

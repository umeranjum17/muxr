...
<p align="center">
  ...
  <a href="https://github.com/umeranjum17/muxr/releases/tag/v0.1.23">Release 0.1.23</a>
</p>
...
```bash
npm install -g --ignore-scripts @trymuxr/cli@0.1.23
muxr
```
...
- **All builds:** [muxr 0.1.23 release](https://github.com/umeranjum17/muxr/releases/tag/v0.1.23)

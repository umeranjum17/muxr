...
export const ru: TranslationStructure = {
    ...
    plugins: {
        ...
        limits: {
            ...
            paceLimited: 'Ограничение скорости',
            paceExhausted: 'Исчерпано',
            paceOnTrack: 'В пределах нормы',
            paceAhead: 'С опережением',
        ...
        rightNow: {
            ...
            refreshIn: ({ seconds }: { seconds: number }) => `через ${seconds} с`,

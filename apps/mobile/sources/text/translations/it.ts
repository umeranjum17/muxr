...
export const it: TranslationStructure = {
    ...
    plugins: {
        ...
        stopDictationHint: 'Interrompe la registrazione e avvia la trascrizione',
        ...
        herdrAndMuxrFooter: 'Herdr esegue azioni, riquadri o eventi per questi, che aggiungono interfaccia muxr.',
        muxrOnly: 'Solo muxr',
        ...
        limits: {
            ...
            low: 'Quasi esaurito',
            limited: 'Limitato',
            paceLimited: 'Limitato',
            paceExhausted: 'Esaurito',
            paceOnTrack: 'In linea',
            paceAhead: 'In anticipo',
        ...
        rightNow: {
            title: 'Adesso',
            collecting: 'Raccolta dell’utilizzo…',
            unavailable: 'Utilizzo non disponibile · tocca per riprovare',
    ...
    spacesTree: {
        ...
        groupCount: ({ count, kind }: { count: number; kind?: string }) => {
            ...
            return kind === undefined
                ? `${count} ${plural({ count, singular: 'area di lavoro', plural: 'aree di lavoro' })}`
                : `${count} ${plural({ count, singular: 'area di lavoro', plural: 'aree di lavoro' })} (${kind})`;
        },
        needsYou: 'richiede te',
        ...
        shell: 'terminale',
        childEmpty: 'vuoto',
        childAgents: ({ count }: { count: number }) => `${count} ${plural({ count, singular: 'agente', plural: 'agenti' })}`,
        noMatches: 'Nessuno spazio corrisponde',
        expand: 'Mostra altri',
        collapse: 'Mostra meno',
        openLabel: ({ label, line2 }: { label: string; line2: string }) => `Apri ${label}, ${line2}`,
    },
    ...
    commandPalette: {
        ...
        commonReplies: 'Risposte frequenti',
        yourCommands: 'I tuoi comandi',
        editQuickActions: 'Modifica risposte e comandi…',
    },
    ...
    files: {
        ...
        nextFileNamed: ({ title, ordinal, total }: { title: string; ordinal: number; total: number }) => `File successivo, ${title}, ${ordinal} di ${total}`,
        filePosition: ({ current, total }: { current: number; total: number }) => `File ${current} di ${total}`,
        diffUnavailable: 'Diff, non disponibile, nessuna modifica per questo file',

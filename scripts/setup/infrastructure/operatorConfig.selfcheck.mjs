...
try {
    ...
    // External endpoints, one strict rule for flag and file alike: root
    // wss://host, no credentials/query/fragment, never plain ws:// — so a
    // secret-bearing URL can never be serialized as the safe config.

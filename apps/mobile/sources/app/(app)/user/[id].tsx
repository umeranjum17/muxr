...
import { getUserProfile, sendFriendRequest, removeFriend } from '@/catalog/infrastructure/apiFriends';
import { UserProfile, getDisplayName } from '@/catalog/infrastructure/friendTypes';

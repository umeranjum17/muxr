...
import { startRealtimeCapability } from '@/realtime/startRealtimeCapability';
...
/**
 * Effects a manifest can ask for on the phone. Metadata keeps safety
 * requirements generic: downloaded manifests can reference behaviour, never
 * introduce it or bypass its required native surface.
 */

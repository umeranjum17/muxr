        ...
        return (
            <ItemList>
                ...
                <ItemGroup title="Status">
                    ...
                    <Item title="Transport & privacy" subtitle={`${initial.relayUrl.startsWith('wss://') ? 'TLS (WSS)' : 'WS without TLS'} transport · end-to-end encrypted agent data`} subtitleLines={0} />

...
- **Watch an agent browser:** `muxr browser session open http://localhost:PORT/path`
  opens the page in the host browser and offers its live view in the current
  muxr session. The phone's session screen shows a Watch button for that offer.

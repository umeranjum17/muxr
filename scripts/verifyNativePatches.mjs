...
const nativeGuard = androidBuild.indexOf('node "$ROOT/scripts/verifyNativePatches.mjs"');
...
const checks = [
    ...
    [
        'Android build prepares workspace outputs after native guards and before Vitest/EAS',
        nativeGuard >= 0 &&

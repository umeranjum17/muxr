...
**Terminal Link**:
A URL an Agent printed. Loopback HTML can open as Preview; web links open outside the app, other schemes never do. The terminal asks before opening a link; see [terminal usage](README.md#what-you-can-do).

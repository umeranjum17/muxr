...
let currentLanguageTag: string = DEFAULT_LANGUAGE;
        ...
        if (l.languageCode) {
            ...
            if (l.languageCode === 'zh') {
                ...
                if (chineseVariant && chineseVariant in translations) {
                    ...
                    currentLanguageTag = l.languageTag ?? currentLanguage;
...
/** Full device tag for plugin manifests; preferred app languages stay explicit. */
